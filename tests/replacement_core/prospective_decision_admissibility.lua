...
equal(bothPass.selectedCandidateId,forward.identity,"existing Forward Intersection precedence must survive when both groups are admissible")
equal(bothPass.comparisonBasis.selectedGroupKey,"forward-intersection")
