...
def test_phase13_fresh_portfolio_enumerates_support_groups_without_control_authority():
    ...
    for token in (
        ...
        "D0147_TERMINAL_RECORD",
        "ONE_OPPOSED_RELATIONSHIP",
        "COLD_OBSTRUCTION",
        "WARM_D0147",
        "FORWARD_INTERSECTION_FAIL_CLOSED",
        "ACTION_SPACE_FAIL_CLOSED",
        "ONE_CONFLICT_SUPPORT_VIEW_NO_INTER_CONFLICT_SELECTION",
...
def test_phase13_decision_owns_inter_group_compatibility_and_no_constraint_fallback():
    ...
    for forbidden in ("ControlRequest","g_currentMission","driveToPoint"):
...
def test_phase13_runtime_uses_portfolio_only_for_fresh_scope_and_projects_dispatch_boundary():
    ...
    for forbidden in ("TerminalEgressControl","ObstructionRelocationControl","driveInWorldDirection","AIVehicleUtil"):
...
def test_phase13_prospective_decision_test_identity_is_coherent():
