-- FS25_OuttaMyWay v4.7.40 temporary TS015 native-continuation restoration comparison candidate entry point; production Decision/Control remains disabled.
...
local modules={
    ...
    "scripts/constraints/ConstraintEngine.lua","scripts/decision/DecisionSelector.lua","scripts/diagnostics/ArchitectureTrace.lua","scripts/replay/ConformanceAssertions.lua","scripts/replay/ReplayRunner.lua","scripts/diagnostics/TargetedFieldIdentityProbe.lua","scripts/diagnostics/FutureSpaceHud.lua","scripts/diagnostics/TransitionHud.lua","scripts/diagnostics/PassiveLiveValidator.lua","scripts/diagnostics/ProductiveContinuationProbe.lua","scripts/prototypes/Prototype22PermissionGate.lua","scripts/prototypes/Prototype22DriveAuthority.lua","scripts/prototypes/Prototype22ConfigurationAuthority.lua","scripts/prototypes/Prototype22TS015Relocation.lua","scripts/prototypes/Prototype22CapabilityGate.lua","scripts/runtime/Runtime.lua"
}
