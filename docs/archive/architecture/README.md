...
- `DESIGN_v4.6.71.md`
- `KNOWN_ISSUES_v4.6.71.md`

Compatibility copies under this archive preserve the original relative links used by the v4.6.71 snapshots. They are not current authority.
