...
| Post-Job Player Claim | Accepted | After Job termination, player entry into a completed assembly under bounded OuttaMyWay physical actuation is a higher-authority D-0147 claim requiring immediate relinquishment. | [Runtime §7](architecture/RUNTIME_RESPONSIBILITY_ARCHITECTURE.md#7-completion-leaves-occupancy-not-responsibility) |
