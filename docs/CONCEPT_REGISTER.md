...
| Obstruction Relocation | Accepted | Bounded Resolution response for a non-active, unclaimed Causal Obstruction; past Job history and vehicle ownership are not permission prerequisites. | [Runtime §8](architecture/RUNTIME_RESPONSIBILITY_ARCHITECTURE.md#8-beneficiary-and-controlled-subject) |
