...
| ENDED Job Episode Non-Activity Evidence | Accepted | A positively ENDED GIANTS Job Episode may establish the activity side of non-active blocker classification for that former worker; cold blockers instead use current inactivity observation. A new ACTIVE Job Episode is ordinary Situation change, not relocation-specific supersession. | [Runtime §6](architecture/RUNTIME_RESPONSIBILITY_ARCHITECTURE.md#causal-obstruction) |
