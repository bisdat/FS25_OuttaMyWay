...
6. **First exclusive vertical slice** — one bounded Hold/release lifecycle owned entirely by the replacement core.
7. **Controlled expansion** — multi-stage refuge, lifecycle boundaries and broader fixtures one canonical responsibility at a time.
