...
Concrete Resolution Specifications, including [`COOPERATIVE_PASSAGE.md`](COOPERATIVE_PASSAGE.md), [`OBSTRUCTION_RELOCATION.md`](OBSTRUCTION_RELOCATION.md) and [`BLOCKED_WORKER_RECOVERY.md`](BLOCKED_WORKER_RECOVERY.md), own purpose-specific obligations, evidence contracts and choreography. They MUST inherit this parent persistence/terminal contract rather than restate or fork it.
