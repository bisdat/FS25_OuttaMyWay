...
- Corner Atlas, Headland Association, Corner Approach Demand, current Corner Occupancy, Corner Admission, Corner Engagement, Corner Arrival evidence and Positive Corner Departure;
...
- **Positive current Corner Occupancy without prior Approach Admission** — publish current occupancy and admit retained Corner Engagement; Reality has already entered the constrained feature.
- **Shared Corner competing demand** — publish current occupant status and supported native time-to-Corner for each participant where available; do not assign priority in Situation Assessment and do not use Engagement establishment age as a temporal ordering signal.
...
- **Fresh same-Job Corner Approach Demand or current Corner Occupancy appears after a prior Positive Corner Departure** — treat the prior departure as completed-traversal history and permit a new Corner Engagement; do not use the old departure as an admission veto.
