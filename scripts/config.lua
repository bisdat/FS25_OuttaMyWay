-- FS25_OuttaMyWay v0.3.0.14 TEST — Current Physical Assembly Observation.
...
OuttaMyWay.BUILD_LABEL = "0.3.0.14 TEST — CURRENT PHYSICAL ASSEMBLY OBSERVATION"
