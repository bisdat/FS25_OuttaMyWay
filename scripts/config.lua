-- FS25_OuttaMyWay v0.3.0.9 TEST — Regulation responsibility generalisation.
...
OuttaMyWay.BUILD_LABEL = "0.3.0.9 TEST — REGULATION RESPONSIBILITY GENERALISATION"
