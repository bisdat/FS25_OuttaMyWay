-- FS25_OuttaMyWay v0.3.0.43 TEST — STRANDED LEAF SEMANTIC RETIREMENT.
...
OuttaMyWay.BUILD_LABEL = "0.3.0.43 TEST — STRANDED LEAF SEMANTIC RETIREMENT"
