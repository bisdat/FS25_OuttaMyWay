...
function Adapter:publish(raw)
    ...
    for _,item in OuttaMyWay.ValueRecord.ipairs(raw.operationMembershipEvidence or {}) do
        ...
        operationMembershipEvidence[#operationMembershipEvidence+1]={
            ...
            fieldWorldSnapshotReferenceKey=item.fieldWorldSnapshotReferenceKey,
    ...
    local snapshot=OuttaMyWay.ObservationSnapshot.new({
        ...
        diagnostics=raw.diagnostics~=nil and shallowCopy(raw.diagnostics) or nil
    })
