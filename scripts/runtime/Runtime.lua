...
function Runtime.new()
    ...
    local runtime=setmetatable({
        ...
        trace=OuttaMyWay.ArchitectureTrace.new(),initialized=false,runtimeMode=OuttaMyWay.RUNTIME_MODE,cooperativeVerdictTraceKey=nil
    },Runtime)
...
function Runtime:getStatus()
    return {initialized=self.initialized,runtimeMode=self.runtimeMode,
