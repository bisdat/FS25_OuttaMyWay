...
function Runtime:initialize()
    ...
    print(string.format("FS25_OuttaMyWay %s loaded; D-0192 Bounded Axis Return: v0.1.12.0 Phases 1-7 preserved; Phase 8 adds whole-assembly alignment plus one-at-a-time straight Axis Return with positive current-occupancy token transfer and safe fallback; D-0188/D-0186 remain active; automatic terminal-yield gate=%s",tostring(OuttaMyWay.BUILD_LABEL or ("v"..tostring(OuttaMyWay.VERSION))),tostring(OuttaMyWay.AUTOMATIC_TERMINAL_EGRESS==true)))
end
