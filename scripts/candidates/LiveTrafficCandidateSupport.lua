...
local function makeD0146ActionSpaceCandidate(pictureId,pictureValues,item,governingRequirementKey,existingCommitmentId,representationId)
    ...
    constraints.CONTROL_CAPABILITY_AVAILABILITY=d0146ActionSpacePacket(
        "The existing P22 Regulation lease can express the Bounded-Authority-owned Resolution-Space Progression Envelope while GIANTS retains route, steering and direction; a zero integer cap is Hold as the terminal magnitude of the same envelope",
