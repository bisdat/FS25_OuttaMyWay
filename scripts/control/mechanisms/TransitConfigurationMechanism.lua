...
-- Defensive Fallback != Shared Policy Owner. Consume the derived capability
-- timeout first; missing cached timing retains an independent Control fail-safe.
local CACHED_TRANSIT_SETTLEMENT_DEFENSIVE_FALLBACK_MS = 30000
