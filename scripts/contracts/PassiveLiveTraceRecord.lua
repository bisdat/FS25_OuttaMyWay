...
OuttaMyWay.PassiveLiveTraceRecord = OuttaMyWay.ValueRecord.register(
    ...
    OuttaMyWay.ValueRecord.define(
        "PassiveLiveTraceRecord",
        {"identity","epoch","timestamp","status","activeAssemblyCount","activeJobEpisodeCount","activeOperationCount","situationCount","currentPairAssessmentCount","generalControlAuthorityEnabled","provenance"},
        {"observationSnapshotId","operationalPictureId","candidateInventoryId","verdictSetId","decisionId","selectedCandidateId","selectedCapability","nonIntervention","error",
         ...
         "cycleActiveJobVehicleCount","poseResolvedWorkerCount","activeOperationMemberCount","mathematicallyPossiblePairCount","relevantPairCount","eligiblePairCount","evaluatedPairCount","excludedPairCount","qualifyingPairCount","interactionEvidenceEmittedCount","interactionEvidenceReceivedCount",
         "admittedEpisodeIds","endedEpisodeIds","assemblyDiagnostics","pairDiagnostics","diagnosticContradictions","currentPairScopeDiagnostics","activeAssemblyReferenceKeys","futureSpaceRelationshipCount","futureSpaceRelationships","boundedControlDispatchStatus","boundedControlRequestId","boundedControlOutcomeId"},
        function(values)
