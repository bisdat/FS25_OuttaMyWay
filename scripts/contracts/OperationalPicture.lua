...
OuttaMyWay.OperationalPicture = OuttaMyWay.ValueRecord.register(
    ...
    OuttaMyWay.ValueRecord.define(
        ...
        {"diagnostics", "motionEvidence", "physicalSpaceEvidence", "productiveContinuationKnowledge", "followerBoundaryKnowledge", "trajectoryKnowledge", "opposedCorridorKnowledge", "spatialConstraintKnowledge", "cooperativePassageKnowledge", "causalObstructionKnowledge", "resolutionMarginDemandKnowledge"},
        validate
    )
)
