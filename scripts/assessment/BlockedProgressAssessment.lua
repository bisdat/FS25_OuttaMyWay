...
local function stallEvidencePayload(track,context,anchor)
    return {
        ...
        stallTimestamp=track.stall and track.stall.timestamp or nil,
        stallX=track.stall and track.stall.poseX or nil,
        stallZ=track.stall and track.stall.poseZ or nil,
        collapseSeconds=track.collapseObservedSeconds,
        trailWitnesses=#track.trail,
