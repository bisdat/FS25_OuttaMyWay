...
local function registerRuntimeBundleListeners()
    ...
    addModEventListener(OuttaMyWay.blockedWorkerRecoveryControl)
...
local function createRuntimeBundle()
    ...
    local blockedWorkerRecoveryControl=OuttaMyWay.BlockedWorkerRecoveryControl.new(runtime,sharedPhysicalControlMechanisms)
    runtime:setBlockedWorkerRecoveryControl(blockedWorkerRecoveryControl)
    ...
    listeners[#listeners+1]=blockedWorkerRecoveryControl
    ...
    return {
        ...
        blockedWorkerRecoveryControl=blockedWorkerRecoveryControl,
