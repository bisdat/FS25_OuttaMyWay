...
local modules={
    ...
    "scripts/assessment/RepresentationFitness.lua","scripts/assessment/EncounterRegistry.lua","scripts/assessment/ProgressionGeometry.lua","scripts/assessment/GuardedRecoveryThreatAssessment.lua","scripts/assessment/FollowerBoundaryDemandAssessment.lua","scripts/assessment/CooperativePassageAssessment.lua","scripts/assessment/TrajectoryConflictAssessment.lua","scripts/assessment/PassageCapabilityAssessment.lua","scripts/assessment/SituationAssessment.lua",
    ...
    "scripts/candidates/CandidateSpace.lua","scripts/candidates/PassiveLiveCandidateSupport.lua","scripts/candidates/LocalPassagePlanner.lua","scripts/candidates/LiveTrafficCandidateSupport.lua","scripts/constraints/ConstraintEvidence.lua",
