...
local modules={
    ...
    "scripts/assessment/RepresentationFitness.lua","scripts/assessment/CurrentPairAssessmentScope.lua","scripts/assessment/ProgressionGeometry.lua","scripts/assessment/FollowerBoundaryDemandAssessment.lua","scripts/assessment/TrajectoryConflictAssessment.lua","scripts/assessment/PassageCapabilityAssessment.lua","scripts/assessment/CausalObstructionAssessment.lua","scripts/assessment/TerminalOccupancyAssessment.lua","scripts/assessment/SpatialConstraintAssessment.lua","scripts/assessment/CurrentResponsibilityAssessment.lua","scripts/assessment/SituationAssessment.lua",
