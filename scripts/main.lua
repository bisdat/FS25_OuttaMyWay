-- FS25_OuttaMyWay v4.7.76 CANONICAL CANDIDATE — functional runtime logic retained from the live-validated v4.7.75 test build; owner-declared v4.7.49 remains canonical pending explicit declaration.
