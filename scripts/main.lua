-- FS25_OuttaMyWay v4.7.3 deterministic Decision entry point.
...
local modules={
    ...
    "scripts/commitment/CommitmentStateMachine.lua","scripts/commitment/CommitmentRegistry.lua","scripts/commitment/ObligationLedger.lua","scripts/authority/AuthorityRegistry.lua","scripts/authority/EffectiveActuationComposition.lua",
    ...
    "scripts/constraints/ConstraintEngine.lua","scripts/decision/DecisionSelector.lua","scripts/diagnostics/ArchitectureTrace.lua","scripts/runtime/Runtime.lua"
}
