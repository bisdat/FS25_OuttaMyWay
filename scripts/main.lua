...
local modules={
    ...
    "scripts/constraints/ConstraintEngine.lua","scripts/decision/TrafficPolicemanDecisionPolicy.lua","scripts/decision/DecisionSelector.lua","scripts/diagnostics/ArchitectureTrace.lua","scripts/diagnostics/BoundaryFeaturePersistenceProbe.lua","scripts/diagnostics/BoundaryTurnTrajectoryProbe.lua","scripts/diagnostics/BoundaryFeatureLineageProbe.lua","scripts/replay/ConformanceAssertions.lua","scripts/replay/ReplayRunner.lua","scripts/diagnostics/TargetedFieldIdentityProbe.lua","scripts/diagnostics/FutureSpaceHud.lua","scripts/diagnostics/PassiveLiveValidator.lua","scripts/diagnostics/ProductiveContinuationProbe.lua","scripts/diagnostics/NativeFieldWorkerDriveCommandProbe.lua","scripts/diagnostics/ProgressionPreservationProbe.lua","scripts/diagnostics/VersionHud.lua","scripts/diagnostics/FollowerPacingHud.lua","scripts/control/mechanisms/FieldWorkHoldMechanism.lua","scripts/control/mechanisms/NativeDriveMechanism.lua","scripts/control/mechanisms/TransitConfigurationMechanism.lua","scripts/control/CooperativePassageControl.lua","scripts/control/ObstructionRelocationControl.lua","scripts/authority/ResolutionSpaceProgressionEnvelope.lua","scripts/authority/FollowerBoundaryMagnitudePolicy.lua","scripts/authority/RegulationBoundedAuthority.lua","scripts/control/RegulationControl.lua","scripts/control/LiveControlDispatcher.lua","scripts/runtime/LiveRuntimeCoordinator.lua","scripts/runtime/Runtime.lua"
}
...
OuttaMyWay.boundaryFeaturePersistenceProbe=OuttaMyWay.BoundaryFeaturePersistenceProbe.new(OuttaMyWay.runtime.fieldWorldSnapshots)
OuttaMyWay.boundaryTurnTrajectoryProbe=OuttaMyWay.BoundaryTurnTrajectoryProbe.new(OuttaMyWay.runtime.fieldWorldSnapshots)
OuttaMyWay.boundaryFeatureLineageProbe=OuttaMyWay.BoundaryFeatureLineageProbe.new(OuttaMyWay.runtime.fieldWorldSnapshots)
...
if type(addModEventListener)=="function" then
    ...
    addModEventListener(OuttaMyWay.boundaryTurnTrajectoryProbe)
    addModEventListener(OuttaMyWay.boundaryFeatureLineageProbe)
